...
type_pitches_outs["pitch_group"] = np.select(
    ...
    default=None  # or use dtype='object' if assigning to an array
)
...
type_pitches_outs_sum = (
    type_pitches_outs
    .dropna(subset=["pitch_group"])  # remove rows with undefined pitch_group
...
type_pitches["pitch_group"] = np.select(
    ...
    ["Fastball", "Offspeed", "Breaking_Ball"],
    default="Unknown"  # Fix: using a string to match other outputs
)
